...
export async function deleteGeneratedCharacterAssets(storageId) {
...
export async function readGeneratedCharacterAsset(requestPath) {
...
function resolveGeneratedCharacterAssetPath(requestPath) {
...
function expectImageDataUrl(value, fieldName) {
